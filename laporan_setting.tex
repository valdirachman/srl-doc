...
% 
% Judul laporan. 
\var{\judul}{Pengenalan Entitas Kesehatan pada Forum Online dengan Menggunakan Recurrent Neural Network}
% 
% Tulis kembali judul laporan, kali ini akan diubah menjadi huruf kapital
\Var{\Judul}{Pengenalan Entitas Kesehatan pada Forum Online dengan Menggunakan Recurrent Neural Network}
% 
% Tulis kembali judul laporan namun dengan bahasa Ingris
\var{\judulInggris}{Medical Entity Recognition on the Online Health Forum using Recurrent Neural Network}
