...
As we can see from the table above, \agent, \patient, and \greet~gain significant improvements. The F1 score of \agent~increases by 8.2\% (from 81.39\% to 89.59\%) while \patient~improves by 8.07\% (from 77.00\% to 85.07\%). On the other hand, \greet's F1 score dramatically increases by 12.56\% (from 62.73\% to 75.29\%).
